        ...
        @can('attendance_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.attendances.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/attendances') || request()->is('admin/attendances/*') ? 'c-active' : '' }}">
        ...
        @can('employee_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.employee.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/employee') || request()->is('admin/employee/*') ? 'c-active' : '' }}">
