    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.attendances.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_rest') ? 'is-invalid' : '' }}" type="text" name="start_rest" id="start_rest" value="{{ old('start_rest') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_rest') ? 'is-invalid' : '' }}" type="text" name="end_rest" id="end_rest" value="{{ old('end_rest') }}">
